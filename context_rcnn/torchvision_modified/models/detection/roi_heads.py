...
class RoIHeads(torch.nn.Module):
    ...
    def forward(self,
        ...
        return box_features, proposals, matched_idxs, labels, regression_targets

    def get_results(self, box_features, proposals, matched_idxs, labels, regression_targets, image_shapes):
